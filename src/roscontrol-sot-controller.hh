...
class RCSotController : public lci::ControllerBase, SotLoaderBasic {
 ...
 private:
  ...
  std::vector<lhi::ActuatorTemperatureSensorHandle> act_temp_sensors_;
#endif
 ...
 public:
  ...
  /// \brief Read the sensor values, calls the control graph, and apply the
  /// control.
  ///
 ...
 protected:
  ...
  /// \brief Read verbosity level to display messages mostly during
  /// initialization
